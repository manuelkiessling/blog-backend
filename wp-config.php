...
$debian_file = '/opt/blog-backend/wordpress/config-'.strtolower($debian_server).'.php';
/* Main site in case of multisite with subdomains */
$debian_main_server = preg_replace("/^[^.]*\./", "", $debian_server);
$debian_main_file = '/opt/blog-backend/wordpress/config-'.strtolower($debian_main_server).'.php';
