...
function woothemes_seo_page(){
	...
	$seo_options[] = array( "name" => "Use woo_title()",
					"desc" => "Use wp_title() instead of the Woo default for more control. Uses <code>&lt;title&gt;woo_title();&lt;/title&gt;</code> in your theme's header.php",
